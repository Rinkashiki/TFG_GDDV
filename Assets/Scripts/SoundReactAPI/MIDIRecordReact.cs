...
public class MIDIRecordReact : MonoBehaviour
{
    ...
    public void Record_ReliefMap(Mesh mesh, float noiseFactor, float reliefFactor, float waveSpeed, Vector3[] initPos)
    {
        if (MidiRecording.Event_CurrentNoteOn() != null)
        {
            float velocity = MIDIConst.ComputedB(MidiRecording.Event_CurrentNoteOn().GetNoteVelocity()) * MIDIConst.NOTES_TO_FREQ[MidiRecording.Event_CurrentNoteOn().GetNoteNumber()] / MIDIConst.MAX_FREQ;
    ...
    /// <param name="fadeFactor"></param>
    public void Record_LightIntensity(Light light, float intensityFactor, float initialIntensity = 1)
    {
        if (MidiRecording.Event_CurrentNoteOn() != null)
        {
            float velocity = MIDIConst.ComputedB(MidiRecording.Event_CurrentNoteOn().GetNoteVelocity()) * MIDIConst.NOTES_TO_FREQ[MidiRecording.Event_CurrentNoteOn().GetNoteNumber()] / MIDIConst.MAX_FREQ;
    ...
    /// <param name="fadeFactor"></param>
    public void Record_LightRange(Light light, float rangeFactor, float initialRange = 1)
    {
        if (MidiRecording.Event_CurrentNoteOn() != null)
        {
            float velocity = MIDIConst.ComputedB(MidiRecording.Event_CurrentNoteOn().GetNoteVelocity()) * MIDIConst.NOTES_TO_FREQ[MidiRecording.Event_CurrentNoteOn().GetNoteNumber()] / MIDIConst.MAX_FREQ;
    ...
    /// <param name="fadeFactor"></param>
    public void Record_ShaderGraphMatProperty(Material mat, string propertyName, GenericSoundReact.MatPropertyType propertyType, float propertyFactor)
    {
        if (MidiRecording.Event_CurrentNoteOn() != null)
        {
            float velocity = MIDIConst.ComputedB(MidiRecording.Event_CurrentNoteOn().GetNoteVelocity()) * MIDIConst.NOTES_TO_FREQ[MidiRecording.Event_CurrentNoteOn().GetNoteNumber()] / MIDIConst.MAX_FREQ;
    ...
    /// <param name="fadeFactor"></param>
    public void Record_AnimationSpeed(Animator anim, float speedFactor, float initialSpeed = 1)
    {
        if (MidiRecording.Event_CurrentNoteOn() != null)
        {
            float velocity = MIDIConst.ComputedB(MidiRecording.Event_CurrentNoteOn().GetNoteVelocity()) * MIDIConst.NOTES_TO_FREQ[MidiRecording.Event_CurrentNoteOn().GetNoteNumber()] / MIDIConst.MAX_FREQ;
    ...
    /// <param name="fadeFactor"></param>
    public void Record_Bloom(Bloom bloom, float bloomFactor, float initialBloom = 0)
    {
        if (MidiRecording.Event_CurrentNoteOn() != null)
        {
            float velocity = MIDIConst.ComputedB(MidiRecording.Event_CurrentNoteOn().GetNoteVelocity()) * MIDIConst.NOTES_TO_FREQ[MidiRecording.Event_CurrentNoteOn().GetNoteNumber()] / MIDIConst.MAX_FREQ;
    ...
    /// <param name="fadeFactor"></param>
    public void Record_ChromaticAberration(ChromaticAberration ca, float caFactor, float initialCA = 0)
    {
        if (MidiRecording.Event_CurrentNoteOn() != null)
        {
            float velocity = MIDIConst.ComputedB(MidiRecording.Event_CurrentNoteOn().GetNoteVelocity()) * MIDIConst.NOTES_TO_FREQ[MidiRecording.Event_CurrentNoteOn().GetNoteNumber()] / MIDIConst.MAX_FREQ;
    ...
    /// <param name="fadeFactor"></param>
    public void Record_Vignette(Vignette vignette, float vignetteFactor, float initialVignette = 0)
    {
        if (MidiRecording.Event_CurrentNoteOn() != null)
        {
            float velocity = MIDIConst.ComputedB(MidiRecording.Event_CurrentNoteOn().GetNoteVelocity()) * MIDIConst.NOTES_TO_FREQ[MidiRecording.Event_CurrentNoteOn().GetNoteNumber()] / MIDIConst.MAX_FREQ;
    ...
    /// <param name="fadeFactor"></param>
    public void Record_PhysicProperty(Rigidbody body, GenericSoundReact.FloatPhysicProperties fpp, float fppFactor, float initialValue = 0)
    {
        if (MidiRecording.Event_CurrentNoteOn() != null)
        {
            float velocity = MIDIConst.ComputedB(MidiRecording.Event_CurrentNoteOn().GetNoteVelocity()) * MIDIConst.NOTES_TO_FREQ[MidiRecording.Event_CurrentNoteOn().GetNoteNumber()] / MIDIConst.MAX_FREQ;
    ...
    /// <param name="initialValue"></param>
    /// <param name="fadeFactor"></param>
    public void Record_PhysicProperty(Rigidbody body, GenericSoundReact.VectorPhysicProperties vpp, Vector3 vppFactor, Vector3 initialValue = new Vector3())
    {
        if (MidiRecording.Event_CurrentNoteOn() != null)
        {
            float velocity = MIDIConst.ComputedB(MidiRecording.Event_CurrentNoteOn().GetNoteVelocity()) * MIDIConst.NOTES_TO_FREQ[MidiRecording.Event_CurrentNoteOn().GetNoteNumber()] / MIDIConst.MAX_FREQ;
    ...
    /// <param name="initialValue"></param>
    /// <param name="fadeFactor"></param>
    public void Record_PhysicProperty2D(Rigidbody2D body, GenericSoundReact.FloatPhysicProperties fpp, float fppFactor, float initialValue = 0)
    {
        if (MidiRecording.Event_CurrentNoteOn() != null)
        {
            float velocity = MIDIConst.ComputedB(MidiRecording.Event_CurrentNoteOn().GetNoteVelocity()) * MIDIConst.NOTES_TO_FREQ[MidiRecording.Event_CurrentNoteOn().GetNoteNumber()] / MIDIConst.MAX_FREQ;
    ...
    /// <param name="initialValue"></param>
    /// <param name="fadeFactor"></param>
    public void Record_PhysicProperty2D(Rigidbody2D body, GenericSoundReact.VectorPhysicProperties vpp, Vector2 vppFactor, Vector2 initialValue = new Vector2())
    {
        if (MidiRecording.Event_CurrentNoteOn() != null)
        {
            float velocity = MIDIConst.ComputedB(MidiRecording.Event_CurrentNoteOn().GetNoteVelocity()) * MIDIConst.NOTES_TO_FREQ[MidiRecording.Event_CurrentNoteOn().GetNoteNumber()] / MIDIConst.MAX_FREQ;
    ...
    /// <param name="initialScale"></param>
    /// <returns></returns>
    public GameObject Record_Phyllotunnel(Vector3 tunnelSpeed, float phyllotaxisDegree, float speedFactor, float scaleFactor, float cameraDistance = -10, Transform cameraTransform = null, float initialScale = 0)
    {
